...
public class DataShooter extends Fragment implements XListView.IXListViewListener,View.OnClickListener{
	    ...
	    private ArrayList<DataShooterDetail> localData;
	@Override
		...
		protected void onPostExecute(String result) {
			...
			if(result == null){
				...
				case "INIT":
					...
					LinearLayout.LayoutParams ll = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT,LinearLayout.LayoutParams.FILL_PARENT);
					layout.addView(mListView,ll);
					mListView.setXListViewListener(DataShooter.this);
					adapter = new MyAdapter();
					mListView.setAdapter(adapter);
					mListView.addHeaderView(LayoutInflater.from(context).inflate(R.layout.datashooter_header, null));
					progressbar.setVisibility(View.GONE);
	...
	private class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            goal.setText(String.valueOf(localData.get(position).goal));			
			if(position % 2 == 1){
